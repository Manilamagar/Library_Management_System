...
export default function Home() {
    ...
    const [stats, setStats] = useState({ books: 4382, members: 1290, borrowed: 312 });
                ...
                <div style={styles.categories}>
                    {categories.map((c) => (
                        <button
                            ...
                            onClick={() => console.log("filter category", c)}
                        >
                            {c}
                        </button>
                    ))}
                ...
                <div style={styles.featured}>
                    {featured.map((b) => (
                        <div key={b.id} style={styles.bookCard}>
                            <img
                                src={`https://via.placeholder.com/72x100?text=${encodeURIComponent(
                                    b.title.split(" ")[0]
                                )}`}
                                alt={`${b.title} cover`}
                            ...
                            >
                                ...
                                <Link
                                    to={`/books/${b.id}`}
                                    style={{ marginTop: 8, fontSize: 13, color: "#0ea5a4" }}
                                >
                                    Details
                                </Link>
                            </div>
                    ...
                    {recent.map((r) => (
                        ...
                        >
                            ...
                            <div style={{ textAlign: "right" }}>
                                ...
                                <Link
                                    to={`/books/${r.id}`}
                                    style={{ fontSize: 13, color: "#0ea5a4" }}
                                >
                                    View
                                </Link>
                            </div>
